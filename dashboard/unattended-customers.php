 ...
 ?>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="statistical-reports.php">Unattended Customers</a></li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
                ...
                <?php if ($_GET['frequency'] == 'weekly'): ?>
                    <a href="print/print-unattended-customers.php?frequency=<?php echo $_GET['frequency'] ?>&packageId=<?php echo $_GET['packageId'] ?>&week=<?php echo $_GET['week'] ?>" target="blank"><button class="btn btn-info btn-sm mr5"  style="margin-bottom: 20px;">Print</button></a> 
                <?php endif ?>

                <?php if ($_GET['frequency'] == 'monthly'): ?>
                    <a href="print/print-unattended-customers.php?frequency=<?php echo $_GET['frequency'] ?>&packageId=<?php echo $_GET['packageId'] ?>&monthly=<?php echo $_GET['monthly'] ?>" target="blank"><button class="btn btn-info btn-sm mr5"  style="margin-bottom: 20px;">Print</button></a> 
                <?php endif ?>

                <?php if ($_GET['frequency'] == 'yearly'): ?>
                    <a href="print/print-unattended-customers.php?frequency=<?php echo $_GET['frequency'] ?>&packageId=<?php echo $_GET['packageId'] ?>&year=<?php echo $_GET['year'] ?>" target="blank"><button class="btn btn-info btn-sm mr5"  style="margin-bottom: 20px;">Print</button></a> 
                <?php endif ?>
