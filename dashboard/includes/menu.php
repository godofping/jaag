<!-- Sidebar navigation-->
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-home"></i><span class="hide-menu">Home</span></a>
                        ...
                        <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-calendar"></i><span class="hide-menu">Schedules</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-calendar-clock"></i><span class="hide-menu">Bookings</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-washing-machine"></i><span class="hide-menu">Services</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-account-multiple-outline"></i><span class="hide-menu">Customers</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['accountType'] == 'Administrator'): ?>
                            <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-book-open-variant"></i><span class="hide-menu">Billings</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <?php if ($_SESSION['accountType'] == 'Administrator'): ?>
                            <li> <a class="has-arrow waves-effect " aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Settings</span></a>
                            <ul aria-expanded="false" class="collapse">
