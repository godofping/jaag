...
insert  into `payment_transaction_table`(`paymentTransactionId`,`modeOfPaymentId`,`amount`,`dateOfPayment`,`transactionNumber`,`nameOfSender`,`paymentStatus`,`bookingId`,`paymentType`) values (7,4,1399,'2018-09-13','a45sd-a5s4-45sd-5sd','Albert Yap','Recieved',7,'Down Payment');
