...
insert  into `booking_table`(`bookingId`,`profileId`,`travelAndTourId`,`bookingStatus`,`dateBooked`,`numberOfPaxBooked`,`isAttended`) values (21,3,6,'Reserve','2018-10-01',14,0);
...
insert  into `notification_table`(`notificationId`,`notificationMessage`,`profileId`,`dateAndTime`) values (11,'New Booking with the Booking ID: 21 ',2,'2018-10-01 00:29:19'),(12,'New Booking with the Booking ID: 21 ',13,'2018-10-01 00:29:19'),(13,'New payment with the Payment ID: 15 ',2,'2018-10-01 00:52:59'),(14,'New payment with the Payment ID: 15 ',13,'2018-10-01 00:52:59'),(18,'New payment with the Payment ID: 16 ',2,'2018-10-01 01:10:38'),(19,'New payment with the Payment ID: 16 ',13,'2018-10-01 01:10:38'),(20,'Your payment with the Payment ID: 16 is now Recieved and Your booking with the Booking ID: 21 has now the status of Booked',3,'2018-10-01 01:15:40'),(21,'New payment with the Payment ID: 17 ',2,'2018-10-01 01:20:33'),(22,'New payment with the Payment ID: 17 ',13,'2018-10-01 01:20:34'),(23,'Your payment with the Payment ID: 17 has a Wrong Payment Details',3,'2018-10-01 01:26:33'),(24,'Your payment with the Payment ID: 17 has a Wrong Payment Details',3,'2018-10-01 01:26:56'),(25,'Your payment with the Payment ID: 17 is now Recieved and Your booking with the Booking ID: 21 has now the status of Reserve',3,'2018-10-01 01:29:59');
...
insert  into `payment_transaction_table`(`paymentTransactionId`,`modeOfPaymentId`,`amount`,`dateOfPayment`,`transactionNumber`,`nameOfSender`,`paymentStatus`,`bookingId`,`paymentType`) values (17,4,5593,'2018-10-01','asd','asd','Recieved',21,'Down Payment');
