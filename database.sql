...
insert  into `booking_table`(`bookingId`,`profileId`,`travelAndTourId`,`bookingStatus`,`dateBooked`,`numberOfPaxBooked`) values (5,3,1,'Pending Down Payment','2018-09-12',2),(6,3,2,'Pending Down Payment','2018-09-13',1),(7,3,4,'Pending Down Payment','2018-09-13',2);
...
insert  into `comment_table`(`commentId`,`commentInfo`,`profileId`,`dateCommented`) values (2,'aaa',3,NULL),(3,'',3,NULL),(4,'asasd',3,NULL),(5,'asd',3,NULL),(6,'asdasdxx',3,NULL),(7,'testing',3,NULL);
...
insert  into `payment_transaction_table`(`paymentTransactionId`,`modeOfPaymentId`,`amount`,`dateOfPayment`,`transactionNumber`,`nameOfSender`,`paymentStatus`,`bookingId`,`paymentType`) values (6,4,1399,'2018-09-13','a6sd5-as6d5-65sd','Albert Yap','Recieved',7,'Down Payment');
