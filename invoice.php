      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div style="text-align: center;"><img src="dashboard/assets/images/favicon.png" style="height: 80px;">
                <h4>JAAG TRAVEL AND TOURS</h4>
                <h5>BLK. 4, LOT 28, YELLOW VILLAGE, NEW ISABELA <br> TACURONG CITY, SULTAN KUDARAT 9800</h5>
                <h6>CONTACT #: 0997-260-9952    <br>  
                WEBSITE: http://jaag.ml</h6>
                </div>
        		...
        		<div class="row">
        			<div class="col-xs-6">
        				...
        				<strong>Billed To:</strong><br>
        					...
        					<?php echo $res['province']; ?><br>
                            <?php echo $res['contactNumber']; ?>
        				</address>
        			</div>
